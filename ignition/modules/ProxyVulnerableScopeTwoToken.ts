...
const ProxyVulnerableScopeTwoTokenModule = buildModule(
  "ProxyVulnerableScopeTwoTokenModule",
  (m) => {
    ...
    const proxyAdminAddress = m.readEventArgument(vulnerableProxy, "AdminChanged", "newAdmin");
